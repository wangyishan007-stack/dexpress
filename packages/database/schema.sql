...
CREATE TABLE IF NOT EXISTS pools (
  ...
  makers_5m      INTEGER        NOT NULL DEFAULT 0,
  makers_1h      INTEGER        NOT NULL DEFAULT 0,
  makers_6h      INTEGER        NOT NULL DEFAULT 0,
  makers_24h     INTEGER        NOT NULL DEFAULT 0,
...
CREATE INDEX idx_wallet_pnl_chain_period ON wallet_pnl(chain, period, realized_pnl_usd DESC);
