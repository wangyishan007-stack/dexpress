...
function buildPools(): Pool[] {
  ...
  for (let i = 0; i < 50; i++) {
    ...
    pools.push({
      ...
      sells_6h:       sells6h,
      sells_24h:      sells24h,
      buyers_5m:      Math.round(buys5m * 0.7),
      buyers_1h:      Math.round(buys1h * 0.7),
      buyers_6h:      Math.round(buys6h * 0.7),
      buyers_24h:     Math.round(buys24h * 0.7),
      sellers_5m:     Math.round(sells5m * 0.7),
      sellers_1h:     Math.round(sells1h * 0.7),
      sellers_6h:     Math.round(sells6h * 0.7),
      sellers_24h:    Math.round(sells24h * 0.7),
      makers_5m:      makers5m,
      makers_1h:      makers1h,
      makers_6h:      makers6h,
